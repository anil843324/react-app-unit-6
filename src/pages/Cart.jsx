                ...
                >
                  ...
                  <td class="py-4 px-6">
                    <div class="flex items-center space-x-3">
                        ...
                        {/*  decrement button */}
                        <button  onClick={()=> { deQuantity(el.id)}} class="inline-flex items-center p-1 text-sm font-medium text-gray-500 bg-white rounded-full border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                       ...
                       {/* increment button */}
                        <button onClick={()=> { iQuantity(el.id)}} class="inline-flex items-center p-1 text-sm font-medium text-gray-500 bg-white rounded-full border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                            <span class="sr-only">Quantity button</span>
                 ...
                 onClick={ () => {handlePlaceOder(el.id)}}
                      ...
                      class="font-medium text-red-600 dark:text-red-500 cursor-pointer"
                    >
                      Remove
                    </span>
                  </td>
